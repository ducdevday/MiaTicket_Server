...
namespace MiaTicket.Data.Migrations
{
    ...
    [Migration("20241204153648_seed-admin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiaTicket.Data.Entity.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("53793728-a273-4e8a-8e74-ed4fd1b67460"),
                            Account = "admin",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsPasswordTemporary = false,
                            Password = new byte[] { 36, 50, 97, 36, 49, 49, 36, 54, 49, 104, 105, 119, 108, 81, 97, 68, 97, 86, 118, 122, 78, 65, 49, 78, 82, 47, 57, 107, 117, 113, 75, 81, 70, 106, 104, 75, 114, 114, 84, 120, 99, 75, 118, 65, 101, 78, 109, 121, 46, 117, 99, 118, 89, 68, 69, 119, 99, 113, 89, 105 },
            ...
            modelBuilder.Entity("MiaTicket.Data.Entity.EventCheckIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiaTicket.Data.Entity.EventCheckIn", b =>
                {
                    b.HasOne("MiaTicket.Data.Entity.Order", "Order")
                        .WithOne("EventCheckIn")
                        .HasForeignKey("MiaTicket.Data.Entity.EventCheckIn", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
