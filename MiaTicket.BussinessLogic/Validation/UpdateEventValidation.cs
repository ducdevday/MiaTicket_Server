...
{
    public class UpdateEventValidation : BaseValidation<UpdateEventRequest>
    {
        public UpdateEventValidation(UpdateEventRequest input) : base(input)
        {
        }
        ...
        public override void Validate()
        {
            if (string.IsNullOrEmpty(_value.Name)
                ...
                || (_value.IsOffline == true && (string.IsNullOrEmpty(_value.AddressName) || string.IsNullOrEmpty(_value.AddressNo) || string.IsNullOrEmpty(_value.AddressWard) || string.IsNullOrEmpty(_value.AddressDistrict) || string.IsNullOrEmpty(_value.AddressProvince))
